...
public class CategoryServiceImpl implements ICategoryService {
    ...
    /**
     * Saves a new category if it does not already exist.
     */
    @Override
    @Transactional
    ...
    /**
     * Logically deletes a category if it has no associated products.
     */
    @Override
    @Transactional
    ...
    /**
     * Updates a category's name, ensuring no duplication.
     */
    @Override
    @Transactional
